...
HTTP Mock Lib is now available as an unlocked package with the `btcdev` namespace. See the [Installation Guide](/1.2.0/installation) for package installation instructions.
